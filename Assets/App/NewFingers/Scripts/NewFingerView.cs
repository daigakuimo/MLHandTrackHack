...
public class NewFingerView : MonoBehaviour
{
    ...
    {
        this.ObserveEveryValueChanged(visible => useHand == HandGesture.GestureHand.Right ? HandInput.Right.Visible :  HandInput.Left.Visible)
    ...
    private async UniTask InvokeFingerTipPositionUpdate(CancellationToken cancellationToken)
    {
        while (true)
        {
            ...
            var handSkeleton = useHand == HandGesture.GestureHand.Right ? HandInput.Right.Skeleton : HandInput.Left.Skeleton;
